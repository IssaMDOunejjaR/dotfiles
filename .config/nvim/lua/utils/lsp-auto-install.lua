...
local filetype_tools = {
  ...
  javascript = { "tsgo", "prettierd", "js-debug-adapter" },
  javascriptreact = { "tsgo", "rustywind", "prettierd", "js-debug-adapter", "html-lsp", "emmet-language-server" },
  typescript = { "tsgo", "prettierd", "js-debug-adapter" },
  typescriptreact = { "tsgo", "rustywind", "prettierd", "js-debug-adapter", "html-lsp", "emmet-language-server" },
